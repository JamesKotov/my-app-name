...
class FolderTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.FolderTableMap';

    /**
     * The default database name for this class
     */
    const DATABASE_NAME = 'storage_api';
     ...
     */
    const COL_ID = 'folder.id';

    /**
     * the column name for the parent_id field
     */
    const COL_PARENT_ID = 'folder.parent_id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'folder.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(FolderTableMap::COL_ID, FolderTableMap::COL_PARENT_ID, FolderTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(FolderTableMap::COL_ID => 0, FolderTableMap::COL_PARENT_ID => 1, FolderTableMap::COL_NAME => 2, ),
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(FolderTableMap::COL_ID);
            $criteria->addSelectColumn(FolderTableMap::COL_PARENT_ID);
            $criteria->addSelectColumn(FolderTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(FolderTableMap::COL_ID, (array) $values, Criteria::IN);
        }
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                FolderTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(FolderTableMap::COL_ID) && $criteria->keyContainsValue(FolderTableMap::COL_ID) ) {
