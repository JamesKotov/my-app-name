...
class FileTableMap extends TableMap
{
     ...
     */
    const COL_FOLDER_ID = 'file.folder_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'FolderId', 'Name', ),
        self::TYPE_CAMELNAME     => array('id', 'folderId', 'name', ),
        self::TYPE_COLNAME       => array(FileTableMap::COL_ID, FileTableMap::COL_FOLDER_ID, FileTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id', 'folder_id', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'FolderId' => 1, 'Name' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'folderId' => 1, 'name' => 2, ),
        self::TYPE_COLNAME       => array(FileTableMap::COL_ID => 0, FileTableMap::COL_FOLDER_ID => 1, FileTableMap::COL_NAME => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'folder_id' => 1, 'name' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FileTableMap::COL_FOLDER_ID);
