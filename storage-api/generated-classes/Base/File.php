...
abstract class File implements ActiveRecordInterface
{
    ...
    public function setFolderId($v)
    {
        ...
        if ($this->folder_id !== $v) {
            $this->folder_id = $v;
            $this->modifiedColumns[FileTableMap::COL_FOLDER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FileTableMap::translateFieldName('FolderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->folder_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FileTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = FileTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FileTableMap::COL_FOLDER_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aFolder) {
                ...
                $result[$key] = $this->aFolder->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FileTableMap::COL_FOLDER_ID)) {
            $criteria->add(FileTableMap::COL_FOLDER_ID, $this->folder_id);
        }
        if ($this->isColumnModified(FileTableMap::COL_NAME)) {
    ...
    {
        if ($this->aFolder === null && ($this->folder_id != 0)) {
